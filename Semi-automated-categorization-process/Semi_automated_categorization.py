...
try:
    socrata_data_update_cursor=conn.cursor()    
    socrata_data_update_cursor.execute(
        'Update USA_CITY_DATASETS_CATEGORIZED set CATEGORY="Demographics" WHERE THEME IN ("Census","CitiStat","Demographics","Focus","Forecasts","Labor","MIDAS","Neighborhoods","Statistics","Stronger Neighborhoods")')
except:
...
try:
    socrata_data_update_cursor=conn.cursor()    
    socrata_data_update_cursor.execute(
        'Update USA_CITY_DATASETS_CATEGORIZED set CATEGORY="Ethics & Democracy" WHERE THEME IN ("City Management and Ethics","Elections","Ethics","Expenditures","FOIA","General Information","Governance","Government","Human Relations","Human Resources","Information Bulletins","Legislation","Legislative Info","Local Law 11 Compliance Plan","Monthly Status Reports","Payroll","Peer Review","People","Permitting","Personal","Polling Places","Procurement Plan Local Law 63","Public Works","Reference","Regulatory","Regulatory Codes","Scope Statement","State of Vermont","Taxes")')
except:
...
try:
    socrata_data_update_cursor=conn.cursor()    
    socrata_data_update_cursor.execute(
        'Update USA_CITY_DATASETS_CATEGORIZED set CATEGORY="Recreation & Culture" WHERE THEME IN  ("Arts and Culture","Culture & Arts","Culture and Recreation","Events","Greenways","Historic Preservation","Innovation","Library","Parks & Recreation","Recreation","Recreation and Culture")')
except:
