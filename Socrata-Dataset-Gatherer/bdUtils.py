...
def askDBPath():
    ...
    print(r'Default: C:\Users\aeprieto\Google Drive\Linked Open Data\Github\openDataCatalogExtractor\OpenDataCatalogs.sqlite')
...
def openDB():
    ...
    try:
        ...
        print '==== error open DB: path or db name wrong===='
        conn='noDB'
        exit()
    return conn
